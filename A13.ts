...
let transport = ['sedan','hatchback','coupe','convertable','Crossover'];
 for (let n=0 ;n< transport.length ; n++){
    console.log("I would like to own a Honda motorcycle " + transport[n]);
 }